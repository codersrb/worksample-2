...
<div class="contacts-form">
    ...
    <div class="form-group field-contacts-contacttype required updated">
        <label class="control-label">This is a</label>
        <input type="hidden" name="Contacts[contactType]" value="">
        <div id="contacts-contacttype" prompt="" aria-required="true" class="form-container">
            <label><span class="label-text">Person</span>
                <input type="radio" name="Contacts[contactType]" value="Person">
                <span class="selected"></span></label>
            <label><span class="label-text">Company/Location</span>
                <input type="radio" name="Contacts[contactType]" value="Company">
                <span class="selected"></span></label>
        </div>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?php echo $form->field($model, 'fkContactPersonID')->widget(Select2::classname(), [
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactCity')->textInput() ?>
                        </div>
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactState')->textInput() ?>
                        </div>
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactZip')->textInput() ?>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="col-md-6">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55565170.29301636!2d-132.08532758867793!3d31.786060306224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited+States!5e0!3m2!1sen!2sin!4v1530501646470"
                ...
                <div class="col-md-6">
                    <div class="form-group field-contacts-contactbillingaddresstype required updated">
                        ...
                        <div id="contacts-contactbillingaddresstype" class="form-container checkboxes" prompt=""
                             aria-required="true">
                            <label>
                                <input type="radio" name="Contacts[contactBillingAddressType]" value="Contact"
                                       disabled="disabled">
                                Bill Contact Address <span class="selected"></span></label>
                            <label>
                                <input type="radio" name="Contacts[contactBillingAddressType]" value="ParentContact"
                                       disabled="disabled">
                                Bill Parent Contact <span class="selected"></span></label>
                            <label>
                                <input type="radio" name="Contacts[contactBillingAddressType]" value="DifferentAddress"
                                       disabled="disabled">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactBillingCity')->textInput() ?>
                        </div>
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactBillingState')->textInput() ?>
                        </div>
                        <div class="col-md-3">
                            <?= $form->field($model, 'contactBillingZip')->textInput() ?>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <?= $form->field($model, 'contactPropertyCity')->textInput() ?>
                        </div>
                        <div class="col-md-2">
                            <?= $form->field($model, 'contactPropertyState')->textInput() ?>
                        </div>
                        <div class="col-md-2">
        ...
        <div class="box-body">
            <div class="form-group field-contacts-contactcontractor updated">
                ...
                <div id="contacts-contactcontractor" prompt="" aria-invalid="false" class="form-container checkboxes">
                    <label>
                        <input type="radio" name="Contacts[contactContractor]" value="Yes">
                        Yes (Please include their information below) <span class="selected"></span></label>
                    <label>
                        <input type="radio" name="Contacts[contactContractor]" value="No" checked="">
            ...
            <div class="form-group field-contacts-contactreferral updated">
                ...
                <div id="contacts-contactreferral" prompt="" aria-invalid="false" class="form-container checkboxes">
                    <label>
                        <input type="radio" name="Contacts[contactReferral]" value="Yes">
                        Yes <span class="selected"></span></label>
                    <label>
                        <input type="radio" name="Contacts[contactReferral]" value="No" checked="">
                        No <span class="selected"></span></label>
                </div>
                <div class="help-block"></div>
            </div>
            ...
            <div class="form-group field-contactcontractorinfo-selectiontype required updated">
                ...
                <div id="contactcontractorinfo-selectiontype" prompt="" aria-required="true"
                    ...
                    <label>
                        <input type="radio" name="ContactContractorInfo[selectionType]" value="Own">
                        To make a selection on your own <span class="selected"></span></label>
                    <label>
                        <input type="radio" name="ContactContractorInfo[selectionType]" value="Rok" checked="">
...
$('#contacts-contacttype label').on('click', function () {
    $('#contacts-contacttype').find('label').removeClass('lableSelected');
    $(this).addClass('lableSelected');
});
...
$('[name="Contacts[contactBillingAddressType]"]').attr('disabled', true);

$('#contacts-contactaddress').change(function(){
    $('[name="Contacts[contactBillingAddressType]"]').attr('disabled', false);
});
EOD;
